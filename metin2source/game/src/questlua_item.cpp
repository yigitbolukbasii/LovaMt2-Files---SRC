...
namespace quest
{
	...
	int	item_kilit_locked(lua_State* L)
	{
		LPITEM item = CQuestManager::instance().GetCurrentItem();
	...
	int	item_kilit_unlocked(lua_State* L)
	{
		LPITEM item = CQuestManager::instance().GetCurrentItem();
	...
	int	item_is_locked(lua_State* L)
	{
		LPITEM item = CQuestManager::instance().GetCurrentItem();
	...
	void RegisterITEMFunctionTable()
	{
		...
		luaL_reg item_functions[] =
		{
			...
			{ "kilit_locked",	item_kilit_locked},
			{ "kilit_unlocked",	item_kilit_unlocked},
			{ "is_locked",	item_is_locked},
			{ "increase", item_inc},
