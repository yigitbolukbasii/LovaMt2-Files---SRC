...
bool CHARACTER::ExchangeStart(LPCHARACTER victim)
{
	...
	{
		ChatPacket(CHAT_TYPE_INFO, "GameMaster ticaret yapmaz.");
		return false;
	}
...
bool CExchange::CheckSpace()
{
	...
	static CGrid s_grid1(5, inventorysize/5 / 3); // inven page 1
	static CGrid s_grid2(5, inventorysize/5 / 3); // inven page 2
	static CGrid s_grid3(5, inventorysize/5 / 3); // inven page 3
